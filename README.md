...
Это основная версия моего игрового движка. 

Движок является самостоятельным и не требует ничего, кроме библиотеки Vulkan API.
...
- Загрузка моделей [glTF, FBX и Obj]. 
- Поддержка 3D анимации [Формат glTF и FBX].
...
- Встоенная поддержка освещения [Light Object]
- Встроенная поддержка генерация ландшафта [Terrain Object] (В тестовом режиме)
