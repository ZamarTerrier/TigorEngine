...
Это облегчённая версия моего основного игрового движка ZamEngine. Потребовалось решение, которое не будет связывать разработчика с 
ресурсами типа шейдеров и фрифтвом. Такая библиотека является статической и встраивается в вашу программу, что позволяет не использовать
дополнительные зависимости типа dll файлов для запуска вашего приложения.

Это мой небольшой эксперимент и от его успеха или провала зависит будующий курс разработки моего игрового движка.
