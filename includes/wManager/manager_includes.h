...
#define _TIGOR_INSERT_FIRST      0
#define _TIGOR_INSERT_LAST       1
...
#define TIGOR_NO_API                          0

#define TIGOR_PLATFORM_UNAVAILABLE   0x0001000E

#define TIGOR_RESIZABLE              0x00020003

#define TIGOR_CLIENT_API             0x00022001

#define TIGOR_FOCUSED                0x00020001
#define TIGOR_ICONIFIED              0x00020002
#define TIGOR_RESIZABLE              0x00020003
#define TIGOR_VISIBLE                0x00020004
#define TIGOR_DECORATED              0x00020005
#define TIGOR_AUTO_ICONIFY           0x00020006
#define TIGOR_FLOATING               0x00020007
#define TIGOR_MAXIMIZED              0x00020008
#define TIGOR_CENTER_CURSOR          0x00020009
#define TIGOR_TRANSPARENT_FRAMEBUFFER 0x0002000A
#define TIGOR_HOVERED                0x0002000B
#define TIGOR_FOCUS_ON_SHOW          0x0002000C
#define TIGOR_MOUSE_PASSTHROUGH      0x0002000D
#define TIGOR_POSITION_X             0x0002000E
#define TIGOR_POSITION_Y             0x0002000F
#define TIGOR_RED_BITS               0x00021001
#define TIGOR_GREEN_BITS             0x00021002
#define TIGOR_BLUE_BITS              0x00021003
#define TIGOR_ALPHA_BITS             0x00021004
#define TIGOR_DEPTH_BITS             0x00021005
#define TIGOR_STENCIL_BITS           0x00021006
#define TIGOR_ACCUM_RED_BITS         0x00021007
#define TIGOR_ACCUM_GREEN_BITS       0x00021008
#define TIGOR_ACCUM_BLUE_BITS        0x00021009
#define TIGOR_ACCUM_ALPHA_BITS       0x0002100A
#define TIGOR_AUX_BUFFERS            0x0002100B
#define TIGOR_STEREO                 0x0002100C
#define TIGOR_SAMPLES                0x0002100D
#define TIGOR_SRGB_CAPABLE           0x0002100E
#define TIGOR_REFRESH_RATE           0x0002100F
#define TIGOR_DOUBLEBUFFER           0x00021010
#define TIGOR_CLIENT_API             0x00022001
#define TIGOR_CONTEXT_VERSION_MAJOR  0x00022002
#define TIGOR_CONTEXT_VERSION_MINOR  0x00022003
#define TIGOR_CONTEXT_REVISION       0x00022004
#define TIGOR_CONTEXT_ROBUSTNESS     0x00022005
#define TIGOR_OPENGL_FORWARD_COMPAT  0x00022006
#define TIGOR_CONTEXT_DEBUG          0x00022007
#define TIGOR_OPENGL_DEBUG_CONTEXT   TIGOR_CONTEXT_DEBUG
#define TIGOR_OPENGL_PROFILE         0x00022008
#define TIGOR_CONTEXT_RELEASE_BEHAVIOR 0x00022009
#define TIGOR_CONTEXT_NO_ERROR       0x0002200A
#define TIGOR_CONTEXT_CREATION_API   0x0002200B
#define TIGOR_SCALE_TO_MONITOR       0x0002200C
#define TIGOR_COCOA_RETINA_FRAMEBUFFER 0x00023001
#define TIGOR_COCOA_FRAME_NAME         0x00023002
#define TIGOR_COCOA_GRAPHICS_SWITCHING 0x00023003
#define TIGOR_X11_CLASS_NAME         0x00024001
#define TIGOR_X11_INSTANCE_NAME      0x00024002
#define TIGOR_WIN32_KEYBOARD_MENU    0x00025001

#define TIGOR_NO_API                          0
#define TIGOR_OPENGL_API             0x00030001
#define TIGOR_OPENGL_ES_API          0x00030002

#define TIGOR_NATIVE_CONTEXT_API     0x00036001
#define TIGOR_EGL_CONTEXT_API        0x00036002
#define TIGOR_OSMESA_CONTEXT_API     0x00036003

#define TIGOR_NO_ROBUSTNESS                   0
#define TIGOR_NO_RESET_NOTIFICATION  0x00031001
#define TIGOR_LOSE_CONTEXT_ON_RESET  0x00031002

#define TIGOR_OPENGL_ANY_PROFILE              0
#define TIGOR_OPENGL_CORE_PROFILE    0x00032001
#define TIGOR_OPENGL_COMPAT_PROFILE  0x00032002

#define TIGOR_ANY_RELEASE_BEHAVIOR            0
#define TIGOR_RELEASE_BEHAVIOR_FLUSH 0x00035001
#define TIGOR_RELEASE_BEHAVIOR_NONE  0x00035002

#define TIGOR_CONNECTED              0x00040001
#define TIGOR_DISCONNECTED           0x00040002

#define TIGOR_ANY_PLATFORM           0x00060000
#define TIGOR_PLATFORM_WIN32         0x00060001
#define TIGOR_PLATFORM_COCOA         0x00060002
#define TIGOR_PLATFORM_WAYLAND       0x00060003
#define TIGOR_PLATFORM_X11           0x00060004
#define TIGOR_PLATFORM_NULL          0x00060005
